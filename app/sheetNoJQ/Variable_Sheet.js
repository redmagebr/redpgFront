...
window.sheetVariableTypes['sheet'] = function (element, style, parent) {
	...
	this.updateOptions = function (lazy) {
		...
		option.dataset['langhtml'] = "_SHEETCOMMONSPICKSHEETNONE_";
		option.value = '0';
		option.appendChild(document.createTextNode(window.app.ui.language.getLingo("_SHEETCOMMONSPICKSHEETNONE_")));
